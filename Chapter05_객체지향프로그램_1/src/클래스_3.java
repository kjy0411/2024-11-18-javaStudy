 ...
 *  		 1. 변수의 종류
 *  			= 인스턴스 변수(객체변수)
 *  				new를 이용해서 메모리를 따로 저장이 가능하게 만든다
 ...
 *     
 *  ------------------------------------------------------------------------
 * 	종류				메모리 저장 시점		메모리 해제 시점	저장위치		사용범위		사용 방법
 *  ------------------------------------------------------------------------
 *  인스턴스 변수		new를 이용해서 저장		프로그램 종료		Heap		클래스 전체	
 *  																다른 클래스	
 *  ------------------------------------------------------------------------
 *  정적변수(공유변수)	컴파일시 자동 메모리 할당	프로그램 종료 		MethodArea	클래스 전체
 *  				한개만 생성										다른 클래스
 *  ------------------------------------------------------------------------
...
public class 클래스_3 {
	...
	public static void main(String[] args) {
		//1. recipe 저장
		//1. 데이터를 저장할 메모리 공간 생성(메모리 할당)
		Recipe1 recipe1 = new Recipe1();//24byte
		// => 메모리 크기 => 기본형 + 클래스형(4byte)
		// => 초기화
		...
		System.out.println("레시피 조회수 : " + df.format(recipe1.hit));
		...
		System.out.println("레시피 조회수 : " + df.format(recipe2.hit));
