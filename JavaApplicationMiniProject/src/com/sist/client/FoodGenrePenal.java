 ...
 *  2. jPanel => FlowLayout
 */
public class FoodGenrePenal extends JPanel implements ActionListener,MouseListener{
	ControlPanel cp;
	...
	public void print() {
		...
		List<FoodVO> list = dao.foodGenreDate(curpage, strGenre);
	...
	public void mouseExited(MouseEvent e) {
		for(int i = 0; i < imgs.length; i++) {
			if(e.getSource() == imgs[i]) {
				imgs[i].setBorder(new LineBorder(null, 0));
			}
		}
		// TODO Auto-generated method stub
